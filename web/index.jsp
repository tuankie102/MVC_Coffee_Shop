...
<html lang="en">
        ...
        <div class="signin-modal">
            <div class="signin-container">
                ...
                <form action="login" method = "post" ">
                    ...
                    <input type="submit" class="btn-signin btn-submit" value="Login" />
            ...
            <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto p-4">
                        ...
                        <span style="cursor: pointer" class="nav-item nav-link js-signin">Login</span>
                    </div>
                </div>
            </nav>
        </div>
    ...
    <!-- Offer End -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="row align-items-center mb-5">
                            <div class="col-4 col-sm-3" style="position: relative">
                                <a href="AddtoCart?cfId=<%=rs.getInt("maSP")%>" style="align-text: center; position: absolute; bottom: 3px; right: 3px"> <i class="fas fa-plus"></i></a>
                               
                                <img class="w-100 rounded-circle mb-3 mb-sm-0" src="assets/img/<%=rs.getString("hinhAnh")%>" alt="">
        ...
        <!-- Reservation Start -->
    <div id="booking" class="container-fluid my-5">
        <div class="container">
            <div class="reservation position-relative overlay-top overlay-bottom">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 booking-container">
                        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                            <h1 class="text-white mb-4 mt-5">Book Your Table</h1>
                            <form action="up-order-toDb" method="post" class="booking-form">
    ...
    <!-- Reservation End -->
        ...
        <!-- Testimonial End -->
<!-- Page Header Start -->
    <div id="feedback" class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Feedback</h1>
            <div class="d-inline-flex mb-lg-5">
                <p class="m-0 text-white"><a class="text-white" href="">Home</a></p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Feedback</p>
            </div>
        </div>
    </div>
<!-- Page Header End -->
...
<div class="container-fluid pt-5">
    <div class="container">
        ...
        <%
            try {
                SQLDataAccess conn = new SQLDataAccess(); // khởi tạo đối tượng SQLDataAccess

                ResultSet rs = conn.getResultSet("Select * From comments");

                // hiển thị các bình luận lên giao diện
                while (rs.next()) {
        %>
        <div class="comments">
            <div class="comment">
                ...
                <div class="comment-content">
                    ...
                    <div class="user-name"><%=rs.getString("user_name")%>
                        <span class="star-container">
                            <%int valueStar = rs.getInt("star_rating");
                                for (int i = 1; i <= valueStar; i++) {
                            %>
                            <span class="star-done" style="color: #ffcc00">&#9733;</span>
                            <%
                                }
                            %>
                        </span>
                    </div>
                    <div class="comment-text"><%=rs.getString("comment_text")%> </div>
                    <div class="comment-actions">
                        <a href="">Like</a>    <a href="" style="padding: 0px 10px 0px 10px">Trả lời</a>     
                    </div>
                </div>
            </div>
            <%
            ...
            <form class="comment-form" action="up-cmt-toDb" method="post">


                <div class="form-input" style="margin-left: 30px">       
                    <h5>Name:</h5>
                    <input type="text" id="name" name="name"><br><br>
                    <textarea placeholder="Write a comment..." id="comment" name="comment" rows="3" cols="50"></textarea>
                ...
                <div class="rating" style='padding: 0px 20px 0px 20px;height: 100px;'>
    ...
    <!-- Footer End -->
        ...
        <!-- Cart -->
        <a href="cart" style="position: fixed; right: 30px; line-height: 46px; bottom: 120px; color: #212529; background-color: #d38d3c; border-color: #d18731; width: 46px; height: 46px; cursor: pointer; text-align: center; z-index: 11 "><i class="fas fa-shopping-cart"></i></a>
